...
public final class WeatherStations {
    ...
    private void createWeatherStations()
    {
        ...
        WeatherStation ID3 = new WeatherStation(1,"Majs-mark",60.426426,24.377971,5);
        ...
        WeatherStation ID8 = new WeatherStation(2,"Korn-mark",60.425362, 24.374703,5);
        ...
        WeatherStation ID11 = new WeatherStation(1,"Majs-mark",60.426426,24.377971,5);
